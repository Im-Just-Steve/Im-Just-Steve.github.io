...
- Statistics Breakdown now has a second Role filter with All Roles and P.1 and P.1/s options; the selected role filter applies to aircraft/class groups and all displayed statistics.
